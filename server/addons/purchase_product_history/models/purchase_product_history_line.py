...
class PurchaseProductHistoryLine(models.Model):
    ...
    product_history_id = fields.Many2one('product.product', string='Producto',
                                         help='Name of the product')
    order_reference_id = fields.Many2one('purchase.order', string='Compra',
    ...
    date_order = fields.Date(string='Fecha',
                                    help='Date when the product is approved')
