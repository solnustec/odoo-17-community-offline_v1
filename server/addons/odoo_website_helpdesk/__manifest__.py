...
############################################################################
{
    ...
    'data': [
        ...
        'data/helpdesk_area_data.xml',
        'views/helpdesk_category_views.xml',
        'views/helpdesk_area_subarea_views.xml',
        ...
        'views/ticket_upload_attachment_views.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            # '/odoo_website_helpdesk/static/src/js/quick_attach.js',
        ],
        'web.assets_backend': [
            '/odoo_website_helpdesk/static/src/xml/form_status_buttons.xml'
        ]
    },
