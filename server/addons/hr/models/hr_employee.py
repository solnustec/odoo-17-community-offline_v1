...
class HrEmployeePrivate(models.Model):
    ...
    def create(self, vals_list):
        ...
        for employee_sudo in employees.sudo():
            ...
            if employee_sudo.identification_id:
                update_vals = {
                    'vat': employee_sudo.identification_id,
                }
                if hasattr(employee_sudo.work_contact_id, 'l10n_latam_identification_type_id'):
                    update_vals['l10n_latam_identification_type_id'] = 5
                employee_sudo.work_contact_id.write(update_vals)
    ...
    def write(self, vals):
        ...
        for employee in self:
            if 'identification_id' in vals and employee.work_contact_id:
                update_vals = {
                    'vat': vals['identification_id'],
                }
                if hasattr(employee.work_contact_id, 'l10n_latam_identification_type_id'):
                    update_vals['l10n_latam_identification_type_id'] = 5
                employee.work_contact_id.write(update_vals)
