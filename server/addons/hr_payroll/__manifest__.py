...

{
    ...
    'data': [
        ...
        'views/report_payslip_template_liquidations.xml',
        ...
        'views/report_attendance_general.xml',
        'views/template_attendance_general.xml',
        # 'views/hr_popup_liquidations.xml',
        'report/hr_contract_history_report_views.xml',
        # 'report/hr_report_attendances_general.xml',
    ],
