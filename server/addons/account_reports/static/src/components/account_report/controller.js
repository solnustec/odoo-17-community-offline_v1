        ...
        if (!this.reportOptionsMap[cacheKey]) {
            ...
            if (preloading)
                ...
                */
                ...
                /* Reopen the last opened section by default (cannot be done through regular caching, because composite report' options are not
            ...
            if (loadedOptionsCacheKey !== cacheKey) {
                ...
                route report can never be opened directly if they open some variant by default.*/
                delete this.reportOptionsMap[cacheKey];
