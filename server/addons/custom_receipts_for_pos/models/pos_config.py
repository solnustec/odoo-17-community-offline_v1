...
class PosConfig(models.Model):
    ...
    coupon_receipt_template = fields.Many2one('pos.receipt', string='Receipt Design',
                                     help='Choose any receipt design')
    ...
    enable_coupon_printing = fields.Boolean(
        string='Enable Coupon Printing',
        default=False,
        help='When enabled, prints additional coupon tickets based on the '
             'total amount (one per each $10 spent)'
    )
