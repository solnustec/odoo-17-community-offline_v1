...
class QcInspection(models.Model):
    ...
    def object_selection_values(self):
        ...
        """
        return [("product.product", "Producto")]
    ...
    test = fields.Many2one(comodel_name="qc.test", string="Formulario")
    ...
    def action_confirm(self):
        for inspection in self:
            for line in inspection.inspection_lines:
                ...
                elif line.question_type != "qualitative" and line.question_type != "text" and not line.uom_id:
                    raise exceptions.UserError(
                        _(
...
class QcInspectionLine(models.Model):
    ...
    text_value = fields.Text(string="Info")
