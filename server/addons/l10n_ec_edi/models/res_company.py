...
class ResCompany(models.Model):
    ...
    l10n_ec_special_taxpayer_number = fields.Char(
        ...
        help="If set, your company is considered a Special Taxpayer, this number will be printed in electronic invoices and report",
    )
    ...
    l10n_ec_forced_accounting = fields.Boolean(
        ...
        default=True,
        help="Check if you are obligated to keep accounting books, will be used for printing electronic invoices and report",
    )
